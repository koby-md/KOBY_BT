    ...
    enumerable: true
        ...
        reply: {
            ...
            value(jid, text = '', quoted, options) {
                ...
                return Buffer.isBuffer(text) ? conn.sendFile(jid, text, 'file', '', isLid ? null : quoted, false, options) : conn.sendMessage(jid, { ...options, text }, { quoted: isLid ? null : quoted, ...options })
            }
        },
...
download: {
    ...
    async value(text, chatId, options = {}) {
        ...
        const isLid = jid.endsWith('@lid') // تم التعديل هنا لتفادي الرد المقتبس لحسابات lid
